...
buf_set_keymap('n', '<C-f>', '<cmd>lua require(\'lspsaga.action\').smart_scroll_with_saga(1)<CR>', { noremap=true, silent=true })
buf_set_keymap('n', '<C-b>', '<cmd>lua require(\'lspsaga.action\').smart_scroll_with_saga(-1)<CR>', { noremap=true, silent=true })
buf_set_keymap('n', '<space>lr', '<cmd>lua require(\'lspsaga.rename\').rename()<CR>', { noremap=true, silent=true })
buf_set_keymap('n', '<space>la', '<cmd>lua require(\'lspsaga.codeaction\').code_action()<CR>', { noremap=true, silent=true })
buf_set_keymap('v', '<space>la', '<C-U>lua require(\'lspsaga.codeaction\').range_code_action()<CR>', { noremap=true, silent=true })
...
local lspservers = { "go", "lua", "cpp", "java", "bash", "css", "html", "json", "python", "rust", "dockerfile", "vim", "vue" }
...
for _,server in ipairs(lspservers) do
    if not contains(require("lspinstall").installed_servers(),server)
        then
