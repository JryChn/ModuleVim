...
_G.packer_plugins = {
  ...
  ["cmp-calc"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-calc/after/plugin/cmp_calc.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-emoji"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-emoji/after/plugin/cmp_emoji.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-latex-symbols"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-latex-symbols/after/plugin/cmp_latex.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-look"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-look/after/plugin/cmp_look.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-nvim-tags"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-nvim-tags/after/plugin/cmp_nvim_tags.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-spell"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-spell/after/plugin/cmp-spell.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-tabnine"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-tabnine/after/plugin/cmp-tabnine.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-treesitter"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-treesitter/after/plugin/cmp_treesitter.lua" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["cmp-vsnip"] = {
    after_files = { "/home/jeremy/.local/share/nvim/site/pack/packer/opt/cmp-vsnip/after/plugin/cmp_vsnip.vim" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-vsnip", "cmp-treesitter", "cmp-nvim-lua", "cmp-nvim-ultisnips", "cmp-calc", "cmp-spell", "cmp-nvim-tags", "cmp-look", "cmp-emoji", "cmp-tabnine", "cmp-buffer", "cmp-path", "cmp-latex-symbols" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "nvim-jdtls", "lspsaga.nvim" },
    loaded = true,
    only_config = true
  },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "spellsitter.nvim", "nvim-treesitter-textobjects", "nvim-ts-autotag" },
    loaded = true,
    only_config = true
  },
...
try_loadstring("\27LJ\2\0029\0\0\2\0\2\0\0046\0\0\0'\1\1\0B\0\2\1K\0\1\0\30languages.config.nvim-cmp\frequire\0", "config", "nvim-cmp")
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vista.vim', 'barbar.nvim', 'vim-sayonara', 'indent-blankline.nvim', 'nvim-tree.lua', 'which-key.nvim', 'nvim-transparent', 'dashboard-nvim', 'telescope.nvim', 'nvim-toggleterm.lua', 'galaxyline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-vsnip', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-nvim-ultisnips', 'cmp-calc', 'cmp-spell', 'cmp-nvim-tags', 'cmp-look', 'cmp-emoji', 'cmp-tabnine', 'vim-vsnip', 'cmp-buffer', 'cmp-path'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'everforest', 'github-nvim-theme', 'hop', 'gitsigns.nvim', 'gruvbox-material', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
