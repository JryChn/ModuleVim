...
local no_errors, error_msg = pcall(function()
	...
	_G.packer_plugins = {
		...
		["nvim-compe"] = {
			...
			config = {
				"\27LJ\1\2;\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0 languages.config.nvim-compe\frequire\0"
			},
			loaded = false,
			needs_bufread = false,
	...
	vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'galaxyline.nvim', 'dashboard-nvim', 'vista.vim', 'barbar.nvim', 'nvim-tree.lua', 'vim-sayonara', 'telescope.nvim', 'which-key.nvim', 'nvim-transparent', 'nvim-toggleterm.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
