...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop', 'gitsigns.nvim', 'nvim-markdown-preview', 'github-nvim-theme', 'everforest', 'todo-comments.nvim', 'gruvbox-material'}, { event = "BufRead *" }, _G.packer_plugins)]]
