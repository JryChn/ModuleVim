...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-tree.lua', 'barbar.nvim', 'which-key.nvim', 'vista.vim', 'vim-sayonara', 'nvim-toggleterm.lua', 'dashboard-nvim', 'telescope.nvim', 'galaxyline.nvim', 'nvim-transparent'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
